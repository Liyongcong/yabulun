...
@implementation SLLogicTableCell2
...
{
    static NSString *ID = @"logicTableCell2";
    SLLogicTableCell2 *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[SLLogicTableCell2 alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
...
//    self.timeLabel.text = logis.logisticsTime;
    ...
    self.logisLabel.attributedText = [SLStringUtil stringWithString:logis.logisticsDescribe font:SLCellFont3 color:SLColor(207,207,207, 255)];
    // 时间
